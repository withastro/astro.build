...
export const inputBaseClass = clsx(
    'border-2 border-neutral-300 focus:border-primary-400 focus-within:border-primary-400 focus:outline-none rounded px-2 py-2 focus:ring-0 transition bg-white'
)
