...
- Astro 3.2: This update gives you more control over the browser history stack, enables page navigation with View Transitions, includes a route announcer for screen readers, and allows for dynamic integration additions. [Learn more](/).
- Astro 3.3: This release introduces an experimental `<Picture />` component, enhances syntax highlighting, brings package provenance, and adds various quality-of-life improvements. [Read more](/).
- Astro 3.4: One of the most exciting additions is the introduction of Page Partials, along with improvements in image optimization performance and the introduction of an experimental dev overlay. [Discover more](/).
...
- Reviewing brand new content for the docs
- Improved our docs PR template and created a new GitHub action to welcome first-time contributors
- Using (and improving) the Astro Docs checklist for reviewing translation PRs when you don't speak the language
