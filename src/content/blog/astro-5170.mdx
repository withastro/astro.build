...
This enhancement allows you to perform asynchronous operations during file parsing, such as fetching additional data or making API calls:
...
If you'd like to see all the other options available for image transformations, check out the [Astro Images guide](https://docs.astro.build/en/guides/images/) on our docs.
