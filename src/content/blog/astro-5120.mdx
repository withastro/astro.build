...
To use TOML files in your content collections, simply add a `.toml` file to your collection directory. For example, if you have a directory of TOML fileslike this:
...
<Mention name="sarah" />, <Mention name="yan" /> and <Mention name="chee" />.
