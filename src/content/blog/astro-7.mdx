...
Astro 7 replaces the default Markdown and MDX pipeline with [Sätteri](https://satteri.bruits.org/), a Rust-powered processor created by Astro core team member <Mention name="erika" />. Switching the Astro docs and Cloudflare docs builds to Sätteri each shaved over a minute off their build times, making Markdown-heavy sites the biggest winners in Astro 7.
...
Queued rendering is stable, and the default rendering engine. It's **~2.4× faster**[^1] in speed!
