...
[Starlight](https://starlight.astro.build/) is an official theme for building documentation sites with Astro. Since it was released in 2023, it has been steadily gaining popularity, and in 2025 it was used for documentation by many different projects. There are too many to list them all here, but below are a few well known examples:
...
Starlight itself also continued to evolve throughout 2025, with updates including route data middleware, multi-site search support, automatic heading anchor links, and CSS cascade layers, among many others. To keep up with all the improvements, be sure to follow the [Starlight releases on GitHub](https://github.com/withastro/starlight/releases).
...
2025 was a landmark year for Astro's sustainability, with several companies stepping up as official sponsors. In September, [Mux](https://astro.build/blog/mux-official-video-partner/) became the official video partner with a $5,000 monthly sponsorship and released two Astro integrations for video playback and uploading. [Webflow](https://astro.build/blog/webflow-official-partner/) announced a $150,000 donation, with their AI code generation tool built entirely on Astro. [Cloudflare](https://astro.build/blog/cloudflare-official-partner/) also contributed $150,000 and became the official hosting partner. Later in November, [Stainless](https://astro.build/blog/stainless-astro-launch/) joined as a sponsor partner, launching their Stainless Docs Platform built on Starlight. Notably, [Cloudflare and Netlify collaborated](https://blog.cloudflare.com/cloudflare-astro-tanstack/) to support open source projects together, demonstrating that even competitors can unite for the benefit of the web. All of these contributions go directly toward long-term maintenance of the Astro open source project.
...
https://github.com/withastro/roadmap/issues/1208
...
While 2025 did not see a major version release, Astro v6 is planned for 2026. Although the details of the new features are still under wraps, v6 is expected to bring a variety of improvements, including the stabilization of experimental features and enhancements to existing functionality. [Discussions around the v6 scope](https://github.com/withastro/roadmap/discussions/1174) and [draft migration guides](https://github.com/withastro/docs/pull/12322) are already available, so those who are curious can join in by offering feedback or reviewing the proposals.
