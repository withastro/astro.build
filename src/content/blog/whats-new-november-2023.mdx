...
- Big i18n improvements including in Starlight’s asides, component overrides, and language support for Galician, Hindi, and Romanian.
- Full compatibility with Astro’s `trailingSlash` amd `build.format` options.
