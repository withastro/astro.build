...
- We started discussing an `ecosystem-ci` conversation on [Discord](/chat)
- We expanded the Astroverse a tiny bit further with the addition of [daily.dev](https://dly.to/u1jkve3OtCn)
