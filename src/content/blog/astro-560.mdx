...
- [**Removed features from experimental SVG**]()
...
The [experimental SVG RFC](https://github.com/withastro/roadmap/pull/1035) has been under heavy discussion, and for that we thank you all for chiming in! As result of discussions, we decided to *temporarily* remove certain features. This doesn't mean that we won't add them again, but this gives us time to have separate discussions and reach out a good balance between DX and good defaults.
