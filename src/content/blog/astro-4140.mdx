---
title: "Astro 4.14"
description: Astro 4.14 is available now! This release includes a first experimental version of the Content Layer API, experimental support for Intellisense inside content files, and more.
