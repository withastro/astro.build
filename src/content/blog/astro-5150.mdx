...
- **Copy button for stack traces** – The error overlay now includes a copy button to easily share stack traces with LLMs and AI editors for faster debugging. ([#14489](https://github.com/withastro/astro/pull/14489))
...
- **Node.js 18 deprecation** – The Vercel adapter now marks Node.js 18 as deprecated in favor of newer LTS versions. ([#14555](https://github.com/withastro/astro/pull/14555))
