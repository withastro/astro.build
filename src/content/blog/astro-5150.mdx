...
- **Wrangler configuration scaffolding** – The `astro add` CLI now automatically scaffolds `wrangler.jsonc` when adding Cloudflare integration. ([#14564](https://github.com/withastro/astro/pull/14564))
