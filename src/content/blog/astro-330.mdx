...
description: "Astro 3.3 is out with a brand new, experimental `<Picture />` component, improved compatability for syntax highlighting, and package provenance."
...
When we announced [Better Images in Astro](/blog/images/) with our built-in image optimization feature, we committed to taking your feedback about the feature seriously.

Well, after [a comprehensive RFC](https://github.com/withastro/roadmap/pull/715) and [the most highly upvoted PR](https://github.com/withastro/astro/pull/8620) in Astro's history, we are incredibly excited to introduce the built-in `<Picture />` component!
