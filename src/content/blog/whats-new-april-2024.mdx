...
import { Tweet } from '@astro-community/astro-embed';
...
- New regular [Discord event](https://discord.gg/astrodotbuild?event=1230865917957767218): Tech Chat with Platform 🎙️ 
...
- Starlight [0.2w](https://github.com/withastro/starlight/releases/tag/%40astrojs%2Fstarlight%400.22.0)
...
⏱️ Tutorial: [Using Astro and Server-Sent Events (SSE) to Build Realtime In-App Notifications](https://www.koyeb.com/tutorials/
