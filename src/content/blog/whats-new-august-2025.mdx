...
- [Astro 5.13](https://github.com/withastro/astro/blob/refs/heads/main/packages/astro/CHANGELOG.md#5130) - new Content Security Policy (CSP) features, the ability to opt out of HTML streaming when using the Node.js adapter, and more!
...
<YouTubeGrid
  videos={[
    ...
    { id: "https://www.youtube.com/watch?v=TyEIXeq0KD0", title: "Deploy on Gitlip"},
