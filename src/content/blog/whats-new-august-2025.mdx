...
description: 'August 2025 - stuff, stuff, and more!'
...
- [Astro 5.13](https://github.com/withastro/astro/blob/refs/heads/main/packages/astro/CHANGELOG.md#5130) - stuff, and more!
- [Starlight 0.36](https://github.com/withastro/starlight/blob/main/packages/starlight/CHANGELOG.md#0360) - stuff, and more!

## Astro Adopters

From A to B to C, some of the biggest names you know are using Astro!
...
- [PostNord i Kalendern](https://postnord-i-kalendern.se/) - Keep track of Swedish postal deliveries directly in your calendar.
...
Welcome to our newest Astro maintainer [Adam Matthiesen](https://github.com/Adammatthiesen)! The crew just keeps getting larger, and we are happy to have you aboard!
...
- [Build a Lightning-Fast Real-Time App with Astro and Convex](https://www.bitdoze.com/astro-convex-realtime-app/)
...
- [Astro Varlock](https://www.npmjs.com/package/@varlock/astro-integration) - An Astro integration for Varlock to manage your environment variables with type-safety and security.
...
- [BCMS Astro Components](https://www.npmjs.com/package/@thebcms/components-astro) - A set of Astro components to use BCMS content.
...
- 🌟 [Starlight Auto Drafts](https://github.com/HiDeoo/starlight-auto-drafts) - Starlight plugin to tweak draft pages default behavior and automatically remove sidebar links to draft pages in production mode.
