...
Astro 6 also now requires **Node 22** or later, dropping support for deprecated (and soon-to-be-deprecated) Node 18 and Node 20. Node 22 is faster, more secure, and lets us drop polyfills for older Node versions — resulting in a smaller, more maintainable package and better performance in Astro across the board.
