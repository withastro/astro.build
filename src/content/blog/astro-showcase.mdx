...
import screenshot from '/src/assets/blog/astro-showcase/astro-showcase-screenshot.jpg'
...
<div style="
    ...
    align-items: center;">
  <CallToAction primary href="https://astro.build/showcase">Visit the Showcase</CallToAction>
