...
<Note>[partialprerendering.com](https://www.partialprerendering.com/) has had some changes since this post was published. Rerunning the benchmarks maybe produce different results. We stand by these results as accurate the time of publishing.</Note>
