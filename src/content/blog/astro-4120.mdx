...
<BlogSummary>
  Astro 4.12 is out now! This release includes a first experimental release of Server Islands, our new solution to integrate high performance static HTML and dynamic server-generated components together. Improvements to pagination and syntax highlighting are also included.
</BlogSummary>
