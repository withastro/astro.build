...
authors:
    - ben
    - fred
socialImage: '/assets/blog/introducing-content-collections/social.jpg'
coverImage: '/assets/blog/introducing-content-collections/cover.jpg'
lang: 'en'
---

import BlogContentImage from '/src/components/BlogContentImage.astro'
// Images
import bannerErrorOverlayOld from '/src/assets/blog/astro-2/banner-error-overlay-old.png'
...
<video autoplay loop muted playsinline>
    <source src="/assets/blog/introducing-content-collections/data-demo.mp4"
            type="video/mp4"/>
...
<video autoplay loop muted playsinline>
    <source src="/assets/blog/introducing-content-collections/content-demo.mp4"
            type="video/mp4"/>
    Sorry, your browser doesn't support embedded videos.
</video>
...
Learn more about how content collections work in our [docs guide](https://astro.new/en/guides/content-collections/).
...
The first thing you'll notice is that Astro 2.0 comes with a redesigned error overlay. But even more important i that the information has also become more detailed! The exact filename of the offending file are surfaced immediately. A snippet from the file is included to help you understand the problem, along with a link to open that file directly in your code editor. As a nice bonus, hints and tips are included to help you debug your issue.


## Getting started with Content Collections

There's plenty more to explore with content collections, available today in Astro 2.0. You can [head to our content collections guide](https://docs.astro.build/en/guides/content-collections/) to get started, and explore our revamped [**blog**](https://astro.new/blog) and [**docs**](https://astro.new/docs) starters to see content collections in action.
