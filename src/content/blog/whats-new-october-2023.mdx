...
See the `#announcements` channel in the [Astro Discord](https://astro.build/chat) for all releases across the Astro repos, including Starlight, the Astro VS Code extension, compiler, packages, and integrations! Follow [Astro on GitHub](https://github.com/withastro/) for all updates.
