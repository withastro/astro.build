...
See the [Cloudflare adapter changelog](https://github.com/withastro/astro/blob/next/packages/integrations/cloudflare/CHANGELOG.md) for the full list of changes and improvements.
