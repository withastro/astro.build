...
This release adds a new libSQL `web` driver that runs in web-based runtimes wuch as Cloudflare workerd and Deno. The new `mode` configuration option lets you set your client connection type: `node` (default) or `web`.
