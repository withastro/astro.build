...
<CommunityProject 
  ...
  fact="At Astro, we highly value acknowledging our contributors. Our previous method involved a bit of ‘stacking’ (not the type you’re thinking of!) by searching for your git signature on GitHub. Occasionally, this process took longer than the actual PR, but it was a worthwhile effort to show appreciation to our community."
/>
...
<CommunityProject 
  ...
  description="Brand-new integration which adds a external remote image service to astro:assets. You Images will get a remote url which optimizes them, similar to Cloudinary but for free, if you have a Astro Project. It works with every Adapter and Hosting Provider."
