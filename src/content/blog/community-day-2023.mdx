...
<CommunityProject 
  ...
  fact="Lunaria came out of a desire to share the Astro Docs custom i18n translation status tracker, originally built by @hippotastic, with the wider open-source community. Lunaria was built for general compatibility and is suitable for a wide range of different content strategies, frameworks, and even git hosting platforms."
