...
With our thriving developer community and so many new integrations being built all the time, it's important to us that Astro is a great platform for building integrations and we are pleased that this paves the way for even more integrations in the future!
