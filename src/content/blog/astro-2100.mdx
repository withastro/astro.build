...
We've released our first beta of Astro 3.0 as `astro@3.0.0-beta.0`. If you're feeling adventurous, try it today! compatibility issues with your app. So far this release contains mostly deprecations and removals of very old patterns. However, you may experience some compatibility issues or breaking changes.
