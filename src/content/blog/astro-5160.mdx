...
Astro 5.16 adds experimental support for automatic SVG optimization using SVGO, a powerful tool that reduces SVG files size without compromising quality.
