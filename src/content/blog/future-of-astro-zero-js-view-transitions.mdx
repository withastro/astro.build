...
Developers can take advantage of this feature today or wait as it rolls out to more users. Whenever you're ready, it’s essentially a one-line addition of CSS that requires no architectural overhaul to your existing Astro code to enable. To get started, you can learn more about [Astro View Transitions](https://docs.astro.build/en/guides/view-transitions). We will be updating our documentation over the next few weeks to include using these [new native browser APIs](https://developer.chrome.com/docs/web-platform/view-transitions).
