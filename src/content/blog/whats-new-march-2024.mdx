...
description: "March 2024 - Astro DB, Astro Developer Portal and so much more"
...
- [Astro DB](https://astro.build/db/) is now available in early preview! 🚀
...
- 📺 [Netflix-style web app build in Astro](https://youtube.com/watch?v=SZcdUT0osz8) by @jlengstorf
