...
- Adding our new `<Steps />` component to the entire Build a Blog beginner tutorial, and reminding ourselves that not *every* numbered list is a set of instructions to follow.
- Helping a brand new Astro-focused tips and resource site get off the ground, using Starlight to present high quality Astro content like recipes, tutorials and guide.
...
- 📄 [Build your interface in Astro: Components](https://dev.to/dvalin99/build-your-interface-in-astro-components-2gng)
