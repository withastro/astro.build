...
Actions can be called from client-side components and HTML forms. This gives you the flexibility to build apps using any technology: React, Svelte, HTMX, or just plain Astro components. This example calls a newsletter action and renders the result using an Astro component:
...
As we do, Astro 4.16 includes more bug fixes and smaller improvements that couldn't make it into this post! Check out the full [release notes](https://github.com/withastro/astro/blob/refs/heads/main/packages/astro/CHANGELOG.md#4150) to learn more.

Thanks to [Sarah Rainsberger (@sarah11918)](https://github.com/sarah11918), [Yan (@yanthomasdev)](https://github.com/yanthomasdev), [Bjorn Lu (@bluwy)](https://github.com/bluwy), [Emanuele Stoppa](https://github.com/ematipico), [Chris Swithinbank](https://github.com/delucis), and everyone else who contributed to this release.
