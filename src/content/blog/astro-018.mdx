...
import hydration from "~/assets/blog/astro-018/responsive-hydration.webp"
import namedSlots from "~/assets/blog/astro-018/named-slots.webp"
import litLogo from "~/assets/blog/astro-018/lit-logo.svg?raw"
import solidLogo from "~/assets/blog/astro-018/solid-logo-dark.svg?raw"
...
<BlogContentImage
	src={hydration}
	alt="Code example that shows off using the new client:media hydrator."
/>
...
<BlogContentImage
	src={namedSlots}
	alt="Using multiple slots to provide the head and body parts of a Layout component."
/>
...
<p class="box" class="rounded-lg bg-astro-gray-500 p-8" set:html={solidLogo}></p>
<style
	is:inline
	set:text={".box { border-radius: 0.75rem; padding: 2rem 4rem; } p.box svg { box-shadow: none; }"}
/>
...
<p class="box" class="rounded-lg bg-astro-gray-500 p-8 text-astro-gray-100" set:html={litLogo}></p>
