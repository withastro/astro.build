...
import hydration from '/src/assets/blog/astro-018/responsive-hydration.jpg'
import namedSlots from '/src/assets/blog/astro-018/named-slots.png'
import litLogo from '/src/assets/blog/astro-018/lit-logo.svg?raw'
import solidLogo from '/src/assets/blog/astro-018/solid-logo-dark.svg?raw'
...
<p class="box" style="background-color: rgb(65, 64, 66);" set:html={solidLogo}></p>
...
<p class="box" set:html={litLogo}></p>
