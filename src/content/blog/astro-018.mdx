...
<p class="box" class="bg-astro-gray-500 p-8 rounded-lg" set:html={solidLogo}></p>
<style
	is:inline
...
<p class="box" class="bg-astro-gray-500 text-astro-gray-100 p-8 rounded-lg" set:html={litLogo}></p>
