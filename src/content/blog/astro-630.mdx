...
Astro 6.3 introduces experimental support for advanced routing: full control over how requests flow through your application, with first-class support for frameworks like [Hono](https://hono.dev/).

Your app exports the fetch handler pattern used by Cloudflare Workers, Deno, and Bun. Proxy certain paths to another service and let Astro handle the rest:
