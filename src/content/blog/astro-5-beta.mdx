...
With the content layer, you can access your data from anywhere with full confidence in its shape and type. Here's an example of how you can define a collection of blog posts in your Astro project, using Astro's built-in  `glob()` loader for your (quaint, cozy) local Markdown files:
