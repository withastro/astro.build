...
The resulting image will be automatically optimized for you in a modern web format, for maximum performance with minimum [Culminative Layout Shift (CLS)](https://web.dev/cls/).
