...
authors:
  - matthew
socialImage: "/src/content/blog/_images/astro-210/blog-hero-2_1-release.jpg"
coverImage: "/src/content/blog/_images/astro-210/og-image-2_1-release.jpg"
lang: "en"
---

import markdoc from "/src/content/blog/_images/astro-210/markdoc.png"
import astrocheckwatch from "/src/content/blog/_images/astro-210/astro-check-watch.png"
...
Markdoc achieves this by having a declarative approach. This forces a separation between code and content, which sacrifices power and flexibility for performance.

As part of the `@astrojs/markdoc integration`, we built a performance benchmark to compare Markdoc build performance at scale against our existing content formats, Markdown and MDX. In our benchmarking, we have seen up to a 3x improvement over MDX rendering static content with islands of interactivity. The results, along with a complete explanation of the findings can be found [here](https://gist.github.com/bholmesdev/07ec840d0bcdc24c0114268e16b2d0b0).

Markdoc support can be brought into your project by installing our new integration:

```shell
npm install @astrojs/markdoc
```

Markdoc is only available to use through [Content Collections](https://docs.astro.build/en/guides/content-collections/) by adding files with an `.mdoc` file extension. You can mix Markdoc files alongside your other content (Markdown and MDX), so you can do a gradual migration, or just try out the format on a few of your pages.
