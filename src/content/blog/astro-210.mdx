...
- **[Built-in Image Support (experimental)](#built-in-image-support-experimental)**: An experimental feature that brings the learnings from `@astrojs/image` to core.
...
## Built-in Image Support (experimental)
...
A new experimental Markdoc integration has been added in 2.1. [Markdoc](https://markdoc.dev/) is a promising new format by Stripe that was purpose-built to scale to larger sites. Markdoc is a format that builds on top of Markdown, allowing you to build interactive content pages without sacrificing performance.
...
Thanks to everyone that contributed to this outstanding release. In addition to these new features, there were also a bunch of bug fixes throughout the core packages and integrations. See the [release notes](https://github.com/withastro/astro/blob/afaf366fb37bc78a845890cf012dbc7d07bfb305/packages/astro/CHANGELOG.md#210) to learn more.
