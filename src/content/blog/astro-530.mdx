...
Now, thanks to an awesome community contribution from [MatthewLymer](https://github.com/MatthewLymer) on behalf of [VerticalScope](https://www.verticalscope.com/), Astro will only render components asynchronously if... (a)wait for it... they actually contain an async function call.
...
Thanks to everyone who contributed to this release, including [Emanuele Stoppa](https://github.com/ematipico), [Sarah Rainsberger](https://github.com/sarah11918), [HiDeoo](https://github.com/HiDeoo), [Yan Thomas](https://github.com/yanthomasdev), [Dani Fernández](https://github.com/dfdez), [unprintable123](https://github.com/unprintable123), [Sean Boult](https://github.com/Hacksore), [Armand Philippot](https://github.com/ArmandPhilippot), [Vitalii Rybachenko](https://github.com/VitaliyR) and many more. Extra thanks to [MatthewLymer](https://github.com/MatthewLymer) for the excellent work on the faster rendering improvements.
