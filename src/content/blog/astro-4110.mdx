...
New in 4.11, `500.astro` now receives the `error` as a prop. This allows you to give more contextual information about the error. For example, in dev mode you might show the error's stack trace to aid in debugging.
