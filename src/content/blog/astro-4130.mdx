...
For more information on this feature, check out the [Astro rewrites documentation](https://docs.astro.build/en/guides/routing/#rewrite).
...
- [Luiz Ferraz (@Fryuni)](https://github.com/Fryuni)
