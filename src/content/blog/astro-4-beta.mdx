...
Astro 4 is a small major release that is primarily done in order to keep on the latest version of Vite, with Vite 5 having just been released last month.
...
Again, substitute with your favorite package manager.
...
Check out [this demo](https://events-3bg.pages.dev/) which shows what is possible using the new events.
