...
{[
	...
	<li class="border border-astro-gray-500 bg-astro-gray-700 p-4 gap-4 shadow flex before:!hidden">
		<div class="flex-shrink-0 hidden sm:block">
			<img src={image.src} alt="" class="s-16 rounded-full" />
		</div>
		<div class="flex flex-col gap-1.5">
			<h4 class="flex flex-col gap-1">
				<span class="inline-flex gap-2">
					<img src={image.src} alt="" class="s-6 rounded-full sm:hidden" />
					{speaker}
				</span>
...
The event is 100% remote and **free**! So what are you waiting for? [Grab your ticket now](https://viteconf.org/23/ecosystem/astro) and we'll see you there.
