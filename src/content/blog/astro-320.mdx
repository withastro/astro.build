...
Astro 3.2 is out and several new improvments for [view transitions](https://docs.astro.build/en/guides/view-transitions/), 

- **[History Replacement on Links](#history-replacement-on-links)**
- **[JavaScript Navigation API](#javascript-navigation-api)**
