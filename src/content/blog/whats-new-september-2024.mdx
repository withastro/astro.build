...
description: "September 2024 - Beta 5.0, Astro Storefront, and more!"
...
- 🌟 [Swagger docs now built with Astro & Starlight](https://developers.cloudflare.com/learning-paths/get-started/)

## Releases

- Astro [5.0 beta](https://astro.build/blog/astro-5-beta/)
- Starlight [0.27](https://github.com/withastro/starlight/releases/tag/%40astrojs%2Fstarlight%400.27.0), [0.28](https://github.com/withastro/starlight/releases/tag/%40astrojs%2Fstarlight%400.28.0)
...
- [`zastro-service-worker`](zastro-service-worker) - An Astro integration that adds service worker functionality to your Astro project, powered by Workbox.
...
- [Bag of Tricks: `<TurnSignal />`](https://events-3bg.pages.dev/library/ElementCrossing/) - Create distinct animations for forward and backward navigation.
