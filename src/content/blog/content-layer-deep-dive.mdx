...
<BlogSummary>
	The Content Layer API is a new way to handle content in Astro. It unlocks powerful new capabilities, helping you build even more kinds of sites using Astro. This post takes a deep dive into the Content Layer API, and shows you how to use it to build even more kinds of sites using Astro.
</BlogSummary>

This week we have released the first beta of Astro 5, which includes a whole new way to handle content in Astro. It unlocks powerful new capabilities, helping you build even more kinds of sites using Astro.
