...
import astroAddDemo from '/src/assets/blog/astro-025/astro-add-demo.jpg'
...
<BlogContentImage src={astroAddDemo} alt="astro add wizard to 1. enable frameworks 2. select other integrations 3. update your config 4. install all dependencies" />
