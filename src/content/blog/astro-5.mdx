---
title: "Astro 5.0"
description: "Astro 5.0 brings exciting new features like the Astro Content Layer for seamless content organization from any source, and Server Islands for effortlessly combining static and dynamic personalized content."
...
Astro 5 is one of the first framework to ship with Vite 6, just released a week ago. (Don't worry: we've been working with beta releases so you likely won’t need to change any code when upgrading to Astro 5.)
