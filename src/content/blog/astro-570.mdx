...
Almost every website these days use custom fonts. However, it can be surprisingly complicated to get them right: how many font faces should I include? Why do I get a Flash of Unstyled Text? Should I preload?

Fortunately, web APIs have greatly improved recently and thanks to amazing initiatives of the Open-Source community (eg. [`unifont`](https://github.com/unjs/unifont/) and [`capsize`](https://github.com/seek-oss/capsize)), it's now easier than ever to use fonts in Astro!

This experimental feature allows you to use fonts from your filesystem and various providers (eg. Google, Fontsource, Bunny...) through a unified API. Keep your site performant thanks to sensible defaults and automatic optimizations.
...
There's more to discover! Head to [documentation for this experimental feature](https://docs.astro.build/en/reference/experimental-flags/fonts/) for more information. We'd also appreciate your feedback. Participate in the development of the feature on the [Fonts RFC](https://github.com/withastro/roadmap/pull/1039).
