...
Flexibility was another goal. We added the [`getImage()`](https://docs.astro.build/en/guides/assets/#getimage-astroassets) function to optimize an image in your project, on-demand, without using the `<Image />` component. Use this function to build your own custom Image component for any use-case you have in mind.
