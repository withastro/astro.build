...
authors:
  ...
  - fred
lang: "en"
coverImage: "/src/content/blog/_images/images/blog-hero-image-updates.jpg"
socialImage: "/src/content/blog/_images/images/og-image-image-updates.jpg"
---

import { Image } from "@astrojs/image/components"
import imageServiceImage from "./_images/images/service-1-image-updates.jpg"
...
Now, 1 year and 2.5 million downloads later, we're ready to share our new vision for working with images in Astro: completely redesigned with new features, faster performance, and a better end-user experience with [automatic layout shift (CLS) prevention](#automatic-layout-shift-prevention).
...
That's it! Your `stars.png` image will be optimized automatically in the final HTML, as if you had used the `<Image>` component directly. You can also use the `<Image />` component directly in MDX if you prefer, but in most cases the default settings will be enough to produce an optimized file size with a great image quality.
