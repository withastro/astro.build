...
Learn more about View Transitions in our handy [View Transitions guide](https://docs.astro.build/en/guides/view-transitions/), or [this great article](https://developer.chrome.com/docs/web-platform/view-transitions/)  about the browser APIs by the Chrome team. Also read more on our journey to adopt View Transitions on the [Chrome Developer blog](https://developer.chrome.com/blog/astro-view-transitions/).
