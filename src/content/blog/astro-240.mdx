...
In addition to modifying the request and response, with middleware you can mutate a `locals` object that is available in all Astro components and API endpoints. Here's an example of an authentication middleware:
