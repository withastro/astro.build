...
Sometimes, you still want to read a variable that is not defined in the schema. In these cases, `getSecret()` is available to read runtime variables and works with any runtime (Cloudflare, Node.js, Deno).
