...
It's already available as an experimental feature in [Astro 5.0](https://astro.build/blog/astro-5/#experimental-features), and you can check out [the experimental responsive image docs](https://docs.astro.build/en/reference/experimental-flags/responsive-images/) for more details. 
