...
For anyone following the development of [Starlight](https://starlight.astro.build/), HiDeoo should be no stranger! HiDeoo has been working on Starlight for quite a while and introduced some amazing features, plugins and the [`starlight-blog` theme](https://github.com/HiDeoo/starlight-blog) theme.
