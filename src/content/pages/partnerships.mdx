...
We are always happy to work directly with larger sponsors ($2000+ per month) to create a custom sponsorship package. There are also limited options for being an exclusive "official" partner for a particular category ($10,000+ per month):

- Official Hosting Partner: [Netlify](https://www.netlify.com/?utm_campaign=Astro-2024&utm_source=astro-referral)
- Official App Monitoring Partner: [Sentry](https://sentry.io/welcome/?utm_medium=partner&utm_source=astro&utm_campaign=astro-homepage)
- Official Online Editor Partner: [Google Project IDX](https://idx.dev/?utm_source=astro&utm_medium=astro&utm_campaign=astro)
- Official CMS Partner: available
