...
seo:
  ...
  description: "How WP Engine, the world’s largest managed WordPress hosting provider, went from spending most of their time managing their content to actually writing it."
...
authors:
  - astro-team
lang: "en"
socialImage: /src/content/caseStudies/_images/wp-engine/social-image.webp
coverImage: /src/content/caseStudies/_images/wp-engine/cover-image.webp
headerImage: /src/content/caseStudies/_images/wp-engine/header.webp
---

import wpEngineResults from "./_images/wp-engine/wp-engine-results-summary.webp"
import starlightHomepage from "./_images/wp-engine/starlight-homepage.webp"
import starlightDocsExample from "./_images/wp-engine/starlight-docs-example.webp"
import dependabotBeforeAfter from "./_images/wp-engine/dependabot-before-after.webp"
