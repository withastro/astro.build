...
<div class="space-y-8 text-white">
	<div class="text-2xl leading-normal tracking-normal text-astro-gray-100">
		[Thinkmill](https://www.thinkmill.com.au/) is an engineering and design consultancy based in
		Sydney, Australia. They specialize in building [digital
		products](https://www.thinkmill.com.au/services/product-design-engineering) and [design
		systems](https://www.thinkmill.com.au/services/design-systems) with clients including
		[Atlassian](https://www.thinkmill.com.au/work/atlassian) and Westpac (one of Australia’s Big
		Four banks).
	</div>
</div>
