...
Tired of every live-streamed event feeling the same, Jason Lengstorf set out create engaging video content for web developers. Jason's shows focus on original concepts and high production value to provide a TV-like alternative to yet another Zoom call, posted to YouTube. Astro allowed Jason to build an entire media platform that handled both his content and performance needs and "just worked" ... so that he could focus on creating original programming.
