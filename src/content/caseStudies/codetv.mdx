...
To achieve Jason's goals of being a full-fledged media platform, CodeTV needed a solution that was easy to integrate with a variety of services: headless CMS, authentication, e-commerce, video streaming, digital asset management, site search, as well as complex workflow automation connecting everything together.

With all that going on, there was no room for bloat. CodeTV needed to be lightweight and performant. Astro's "opt in to complexity" model was exactly what Jason needed.
