...
Jason's original plan was to "make it work, then make it fast." But he made CodeTV work AND fast, because as Jason noted, "That's just the nature of how you build on Astro." For a complex, content-heavy, media streaming site with several integrations, CodeTV exceeded Jason's expectations of what Astro could achieve.

(lighthouse? some kind of perf graphic or gif of navigating through the site?)
