import sharePearScreenshot from "./share_pear_screenshot.png"
import sharePearScreenshot2 from "./share_pear_screenshot_2.png"
import sharePearExample from "./share-pear-example.mp4"
import BlogContentImage from "~/components/BlogContentImage.astro"
import ImageFigure from "~/components/ImageFigure.astro"

# Content for Everyone: Building Public-Sharing of Blog Drafts in 1 Month

[Contenda](https://contenda.co/), an artificial intelligence company that came onto the scene in 2021, has been building towards the ambitious goal of making content for everyone. Their vision starts with being a catalyst for developer advocates by making repurposing content easy for a variety of mediums.
...
“This was my first time using Astro. I would say, getting started with Astro was simpler than other frameworks. It felt like the onboarding time was way smoother and especially the docs are so up-to-date that it’s a 1-to-1 match with your code sometimes,” says Grady.
...
<ImageFigure caption="A demo of Share Pear">
	<video src={sharePearExample} controls autoplay loading="lazy" />
</ImageFigure>

{/* <BlogContentImage src={sharePearScreenshot} alt="Share Pear screenshot" /> */}
{/* <BlogContentImage src={sharePearScreenshot2} alt="Share Pear screenshot" /> */}
