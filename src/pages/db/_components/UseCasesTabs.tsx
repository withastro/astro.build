...
const tabs: Tab[] = [
	{
		id: "forms",
		label: "Forms",
		icon: <FormsIcon aria-hidden class="w-5" />,
		content: <Forms />,
	},
	{
		id: "feedback",
		label: "Feedback",
		icon: <FeedbackIcon aria-hidden class="w-5" />,
		content: <Feedback />,
	},
	{
		id: "comments",
		label: "Comments",
		icon: <CommentsIcon aria-hidden class="w-5" />,
		content: <Comments />,
	},
	{
		id: "blog",
		label: "Blog",
		icon: <BlogIcon aria-hidden class="w-5" />,
		content: <Blog />,
	},
	{
		id: "auth",
		label: "Authentication",
		icon: <AuthIcon aria-hidden class="w-5" />,
		content: <Auth />,
	},
	{
		id: "ecomm",
		label: "E-commerce",
		icon: <EcommerceIcon aria-hidden class="w-5" />,
		content: <Ecommerce />,
	},
	{
		id: "media",
		label: "Uploads",
		icon: <ImageUploadIcon aria-hidden class="w-5" />,
		content: <Uploads />,
	},
]
