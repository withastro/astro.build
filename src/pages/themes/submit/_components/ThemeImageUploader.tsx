...
function ImagePlaceholder(props: { children?: JSX.Element; previewSrc?: string }) {
	return (
		<div class="group noise-panel relative flex aspect-video flex-col items-center justify-center overflow-clip rounded-2xl border border-dashed border-astro-gray-300 bg-astro-gray-600 ring-2 ring-transparent transition focus-within:ring-purple-500 hover:brightness-90">
			{props.children}
