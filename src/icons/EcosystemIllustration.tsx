	...
	return (
		...
		>
			...
			<g filter="url(#filter4_f_816_816)">
				<circle cx="433.405" cy="433.405" r="95.4049" fill="#222222" />
			</g>
			<defs>
				<filter
				...
				>
					...
					<feGaussianBlur stdDeviation="17.2835" result="effect1_foregroundBlur_816_816" />
				</filter>
				<filter
				...
				>
					<feFlood flood-opacity="0" result="BackgroundImageFix" />
					<feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
					<feGaussianBlur stdDeviation="20.7402" result="effect1_foregroundBlur_816_816" />
				</filter>
				<filter
				...
				>
					<feFlood flood-opacity="0" result="BackgroundImageFix" />
					<feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
					<feGaussianBlur stdDeviation="27.6536" result="effect1_foregroundBlur_816_816" />
				</filter>
				<filter
