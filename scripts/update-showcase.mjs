...
const scraper = new ShowcaseScraper({
	...
	blockedOrigins: [
		...
		// 2026-05-25 - no longer Astro (migrated to WordPress, Ghost, TYPO3, Next.js, Nuxt, or SvelteKit)
		'https://abctoolbox.com/',
		'https://www.aipedia.pro/',
		'https://opusflow.io/',
		'https://www.akh-celle.de/',
		'http://www.webexpressions.io',
		'https://www.isoomena.fi/',
		'https://womradiocafe.com/',
		'https://hellohumans.agency/',
		'https://www.liljeholmstorget.se/',
		'https://jonathansogunquit.com',
		'https://www.kevinzunigacuellar.com/',
		'https://killedby.tech/',
		'https://instrutorleandrocampos.com.br/',
		'https://mesaschool.co/',
		'https://mrstukov.com/',
		'https://onlcalc.online/',
		'https://ramediaa.com',
		...
		'https://pixels.studio',
		'https://sklep.alablaboratoria.pl/',
		'https://www.alexstreza.dev/',
		'https://andreszapata.me/',
		'https://tiyalo.com',
		'https://www.bitech.id',
		'https://www.michler.io/',
		'https://menuvision.es',
		'https://curtainz.ae/',
		'https://dns.surf/',
		'https://domain-stories.com/',
		'https://www.indiamustknow.com',
		'https://ffpixelguide.com',
		'https://fleek.xyz/',
		'https://www.palocko.cz/',
		'https://file.kiwi',
		'https://frontendhire.com/',
		'https://genderswap.fm',
		'https://hachikolabs.io',
		'https://www.touha.dev/',
		'https://hidetaka.dev/',
		'https://ark-ui.com',
		'https://bitwittechno.com/',
		...
		'https://metta.pub/',
		'https://www.murunah.id/',
		'https://docs.orama.com/',
		'https://pooya.blog/',
		'https://mathias.ninja/',
		'https://priyanshusinha.in/',
		'https://www.clemobile.fr/',
		'https://atlas.ourkolkata.in',
		'https://pukima.site/',
		'https://razegrowth.com',
		'https://rotaractgalgotias.org/',
		'https://rnr-docs.vercel.app',
		'https://saulvo.vercel.app/',
		'https://www.sebaslopez.com',
		'https://sonda.dev/',
		'https://www.strands.today/',
		'https://terms.so',
		'https://l1webtips.com',
		'https://www.codelungo.com',
		'https://www.williamsjokvist.se/',
		'https://www.wordble.com/',
		'https://zigistry.dev/',
		'https://haitang.app',
		...
		'https://yoyle.city',
		// 2026-07-17 - old URLs for showcase entries whose url: field was updated
		// to a new domain (site stays listed, just at the new address) — without
		// these, the scraper would re-discover and re-scrape the old URL from the
		// roadmap#521 discussion every run, since #filterHrefs only checks against
		// the *current* url: value, not any prior one.
		'https://ai.cloudflare.com',
		'https://akbarpekat.com',
		'https://andka.my.id',
		'https://animetana.com',
		'https://bariendo.com',
		'https://basssic.now.sh',
		'https://blog.larryxue.dev',
		'https://boutiquestone.co.uk',
		'https://brktfldg.netlify.app',
		'https://davidma.co',
		'https://deep-timeline.oberbrunner.com',
		'https://design.eva.town',
		'https://docs.ghostfam.com',
		'https://dukc.dev',
		'https://eva.town',
		'https://farros.co',
		'https://fevol.github.io',
		'https://fluentmoheshwar.pages.dev',
		'https://giteamirror.com',
		'https://jan-mueller.at',
		'https://kaischuyler.com',
		'https://kamranahmed.info',
		'https://letter.coffee',
		'https://lindnerit.io',
		'https://murtuzaalisurti.github.io',
		'https://oktools365.com',
		'https://photos.trueberryless.org',
		'https://placer-toolkit.netlify.app',
		...
		'https://skyfall.dev',
		'https://smallbee.co',
		'https://taterki.cskl.pl',
		'https://trueberryless.org',
		'https://typeface.us',
		'https://unicorn-utterances.com',
		'https://unitary.fund',
		'https://wtw.dev',
		'https://www.eduwayglobal.co.uk',
		'https://www.futurefabric.co',
		'https://www.gdm-pixel.fr',
		...
		// 2026-08-28 - domain gone, NXDOMAIN confirmed via DoH (dns-check.mjs)
		'https://thedailystoic.art',
		'https://tnp.tcetmumbai.in/',
		'https://tonari.io/',
		'https://top3nftmarketplaces.org/',
		'https://trtcontracting.ca/',
		'https://typethealphabet.online/',
		'https://ukuvota.world/',
		'https://victoria.mossaway.ca',
		'https://video-stable-diffusion.com/',
		'https://whoiam.id.vn/en',
		'https://wildecodx.me/',
		'https://windbasics.com',
		'https://www.31saas.com/',
		'https://www.911dcs.net/',
		'https://www.aksiomatik.com/',
		'https://www.alloresto.app/',
		'https://www.articoliesocial.it/',
		'https://www.astroboard.website/',
		'https://www.atd2023.com/',
		'https://www.beanbuddies.app',
		'https://www.byteship.dev/astro-strapi',
		'https://www.carvimage.com/',
		'https://www.coxcode.io',
		'https://www.creativepages.xyz/',
		'https://www.crosssphereexim.com/',
		'https://www.dealpicks.de/camping/',
		'https://www.digitzen.co/',
		'https://www.dogsittertreviglio.it',
		'http://www.donate2motivate.co.uk',
		'https://www.fanindra.xyz/',
		'https://www.heliumpng.tech/',
		'https://www.herisdia.me/',
		'https://www.jeysonguzman.online/',
		'https://www.looptube.cc',
		'https://www.medecinsalgerie.org',
		'https://www.minov.studio/',
		'https://www.nanofighters.club/es/',
		'https://www.notionpaper.cc/',
		'https://www.profiletherapy.com/',
		'https://www.radenpioneer.work/',
		'https://www.realmof.tech/',
		'https://www.setup.md/',
		'https://www.snezanaspasicautotrasporti.it/',
		'https://www.spolecnafoceni.cz/',
		'https://www.supadev.io',
		'https://www.tarikrital.website/',
		'https://www.unionvisionalliance.com/',
		'https://www.vigorbond.com/',
		'https://yuxxeun.tech',
