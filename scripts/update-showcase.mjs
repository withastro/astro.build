...
const scraper = new ShowcaseScraper({
	...
	blockedOrigins: [
		...
		'https://akshaygore.tech/',
		'https://animerdesateliers.com/',
		'https://anthonygiuliano.dev/',
		'https://artgeneratorai.art/',
		'https://aryadifa.com',
		'https://ask.foolishdev.com/',
		'https://astro-polls.pages.dev/',
		'https://astro-portfolio-aq4.pages.dev/',
		'https://astro.rishi.app/',
		'https://astroboard.website',
		'https://astrocoderstats.fun/',
		'https://astrolize.fabform.io/',
		'https://avikbanik.com/',
		'https://ayanavakarmakar.software/',
		'https://beesvpn.com',
		'https://beradiostereo.com/',
		'https://beta.learning.nicholasdwest.com/',
		'https://beta.tailus.io/demo',
		'https://blog.fanindra.xyz/',
		'https://blog.nguyentruonganhkiet.work/',
		'https://blog.noorudd.in',
		'https://brunoalves.me/',
		'https://butterfree.org/',
		'https://championsheineken.co/',
		'https://charl.sh',
		'https://charlescailleteau.com',
		'https://color.xima.work/en/',
		'https://conversionrefinery.com',
		'https://coolenergyservice.it/',
		'https://corpogrowth.gr/',
		'https://csusb.dev/',
		'https://dendauw.tech/',
		'https://dgang.bwc9876.dev/',
		'https://disrapt.co/',
		'https://docs.astro-studiocms.xyz/',
		'https://docs.iw4x.dev/',
		'https://docs.kuzudb.com/',
		'https://docs.stoppopulationdecline.org',
		'https://elef.codes/',
		'https://exylons.com/',
		'https://flaremingo.com',
		'https://gitfolders.xyz/',
		'https://healthconnectmedia.com/',
		'https://indatech.my.id',
		'https://ioxua.com/br/',
		'https://javadmoradkhah.ir',
		'https://jaycedotbin.me',
		'https://jorgson.tech/',
		'https://josemacruz.dev',
		'https://k0stur.art/',
	],
});
await scraper.run();
